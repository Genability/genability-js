...
export class CalculationHistoryApi extends RestApiClient {
  ...
  public async calculateHistoryResponse(requestId: string): Promise<CalculatedCost> {
  ...
  public async calculateHistoryRequest(requestId: string): Promise<GetCalculatedCostRequest> {
